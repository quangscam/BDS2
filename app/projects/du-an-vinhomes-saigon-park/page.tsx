...
const connections = [
  { icon: Car, title: "Quốc lộ 22 — Trục xuyên Á", description: "Tuyến giao thông huyết mạch kết nối Hóc Môn, Củ Chi, Tây Ninh và hành lang thương mại quốc tế." },
  { icon: Building, title: "Cao tốc TP.HCM — Mộc Bài", description: "Tuyến cao tốc chiến lược được kỳ vọng rút ngắn thời gian di chuyển từ TP.HCM đến Tây Ninh và cửa khẩu Mộc Bài." },
  { icon: Clock, title: "Metro số 2 & Vành đai 3", description: "Khu vực Tây Bắc hưởng lợi từ Metro số 2, Vành đai 3, Quốc lộ 22 nâng cấp và các trục kết nối liên vùng." },
]

const nearbyPlaces = [
  { name: "Quận 12", time: "15 phút" },
  { name: "Củ Chi", time: "20 phút" },
  { name: "Sân bay TSN", time: "30 phút" },
  { name: "Trung tâm TP.HCM", time: "40 phút" },
  { name: "Tây Ninh", time: "60 phút" },
  { name: "Mộc Bài", time: "75 phút" },
]

const productTypes = [
  {
    id: "lienke", name: "Nhà Phố Liền Kề", area: "60m² - 70m² - 80m² - 100m²", price: "Liên hệ CĐT",
    description: "Sản phẩm thấp tầng phù hợp an cư, kinh doanh và đầu tư trong đại đô thị",
    features: ["Diện tích đa dạng 60-100m²", "Công năng ở - kinh doanh", "Kết nối tiện ích all-in-one", "Sở hữu lâu dài theo quy định"],
    popular: true,
    gallery: [
      { src: "/vinhomes-saigon-park/nhapholienke.jpg", title: "Nhà Phố Liền Kề" },
      { src: "/vinhomes-saigon-park/tongquan1.jpg", title: "Không Gian Thấp Tầng" },
      { src: "/vinhomes-saigon-park/matbangtienich.jpg", title: "Mặt Bằng Tham Khảo" },
    ]
  },
  {
    id: "shop", name: "Nhà Phố / Shop", area: "50m² - 60m² - 70m² - 90m² - 100m²", price: "Liên hệ CĐT",
    description: "Sản phẩm thương mại khai thác dòng khách nội khu, giáo dục và dịch vụ",
    features: ["Diện tích linh hoạt 50-100m²", "Mặt tiền kinh doanh", "Phù hợp khai thác cho thuê", "Hưởng lợi từ cộng đồng cư dân"],
    popular: false,
    gallery: [
      { src: "/vinhomes-saigon-park/shophouse.jpg", title: "Nhà Phố / Shop Thương Mại" },
      { src: "/vinhomes-saigon-park/tienich10.jpg", title: "Trục Phố Kinh Doanh" },
      { src: "/vinhomes-saigon-park/tienich11.jpg", title: "Không Gian Thương Mại" },
    ]
  },
  {
    id: "villa", name: "Villa", area: "150m² - 180m² - 200m² - 250m²", price: "Liên hệ CĐT",
    description: "Không gian sống riêng tư cho gia đình tìm kiếm chuẩn sống xanh, tiện ích đồng bộ",
    features: ["Diện tích lớn 150-250m²", "Không gian riêng tư", "Gần công viên và mặt nước", "Phù hợp gia đình đa thế hệ"],
    popular: false,
    gallery: [
      { src: "/vinhomes-saigon-park/villa.jpg", title: "Villa Vinhomes Sài Gòn Park" },
      { src: "/vinhomes-saigon-park/tienich1.jpg", title: "Không Gian Sống Xanh" },
      { src: "/vinhomes-saigon-park/tienich2.jpg", title: "Thiết Kế Villa" },
    ]
  },
]

const showroomGallery = [
  { src: "/vinhomes-saigon-park/tongquan1.jpg", title: "Phối cảnh đại đô thị" },
  { src: "/vinhomes-saigon-park/tongtienich.jpg", title: "Không gian công viên" },
  { src: "/vinhomes-saigon-park/shophouse.jpg", title: "Trục phố thương mại" },
  { src: "/vinhomes-saigon-park/nhapholienke.jpg", title: "Sản phẩm thấp tầng" },
]

const floorPlans = [
  { src: "/vinhomes-saigon-park/matbangtienich.jpg", title: "Mặt Bằng Tổng Quan Đại Đô Thị" },
  { src: "/vinhomes-saigon-park/tongtienich.jpg", title: "Quy Hoạch Tiện Ích Tổng Thể" },
  { src: "/vinhomes-saigon-park/vitri.jpg", title: "Sơ Đồ Vị Trí Dự Án" },
]

const amenitiesGallery = [
  { src: "/vinhomes-saigon-park/tienich1.jpg", title: "01 - Tiện ích nội khu" },
  { src: "/vinhomes-saigon-park/tienich2.jpg", title: "02 - Không gian cảnh quan" },
  { src: "/vinhomes-saigon-park/tienich3.jpg", title: "03 - Hồ bơi nội khu" },
  { src: "/vinhomes-saigon-park/tienich4.jpg", title: "04 - Khu thư giãn" },
  { src: "/vinhomes-saigon-park/tienich5.jpg", title: "05 - Vườn dạo bộ" },
  { src: "/vinhomes-saigon-park/tienich6.jpg", title: "06 - Khu sinh hoạt cộng đồng" },
  { src: "/vinhomes-saigon-park/tienich7.jpg", title: "07 - Gym & wellness" },
  { src: "/vinhomes-saigon-park/tienich8.jpg", title: "08 - Khu vui chơi trẻ em" },
  { src: "/vinhomes-saigon-park/tienich9.jpg", title: "09 - BBQ garden" },
  { src: "/vinhomes-saigon-park/tienich10.jpg", title: "10 - Không gian thương mại" },
  { src: "/vinhomes-saigon-park/tienich11.jpg", title: "11 - Tiện ích cư dân" },
  { src: "/vinhomes-saigon-park/tienich12.jpg", title: "12 - Tổng quan tiện ích" },
  { src: "/vinhomes-saigon-park/tienich13.jpg", title: "13 - Tiện ích cảnh quan" },
  { src: "/vinhomes-saigon-park/tienich14.jpg", title: "14 - Không gian xanh" },
  { src: "/vinhomes-saigon-park/tienich15.jpg", title: "15 - Tiện ích cộng đồng" },
]

const highlightAmenities = [
  { icon: GraduationCap, label: "Đại học quốc tế" }, { icon: Trees, label: "Đại công viên" },
  { icon: ShoppingBag, label: "Vincom" }, { icon: Stethoscope, label: "Vinmec" },
  { icon: Film, label: "Giải trí" }, { icon: Dumbbell, label: "Thể thao" },
  { icon: Waves, label: "Kênh đào" }, { icon: Coffee, label: "F&B" },
  { icon: Baby, label: "Khu trẻ em" }, { icon: Sparkles, label: "Sân golf" },
  { icon: Leaf, label: "Mảng xanh" }, { icon: Shield, label: "An ninh 24/7" },
]

const amenityCategories = [
  { title: "Giáo Dục & Tri Thức", icon: GraduationCap, items: ["Khu đại học quốc tế khoảng 150ha", "Hệ thống trường học Vinschool", "Môi trường cộng đồng chuyên gia", "Không gian học thuật và nghiên cứu"] },
  { title: "Thương Mại & Dịch Vụ", icon: ShoppingBag, items: ["Vincom Mega Mall", "Shophouse thương mại", "Tuyến phố F&B", "Dịch vụ all-in-one"] },
  { title: "Sức Khỏe & Vận Động", icon: Dumbbell, items: ["Vinmec", "Sân golf 36 hố", "Công viên thể thao", "Đường dạo bộ và xe đạp"] },
  { title: "Sinh Thái & An Ninh", icon: Leaf, items: ["Công viên quy mô lớn", "Kênh đào và mặt nước", "Mật độ xây dựng thấp", "An ninh Vinhomes 24/7"] },
]

const milestones = [
  { id: 1, title: "Công bố & khởi công", date: "Năm 2026", description: "Một số nguồn thị trường và báo cáo phân tích ghi nhận dự án được khởi công trong năm 2026." },
  { id: 2, title: "Hoàn thiện thông tin mở bán", date: "Đang cập nhật", description: "Giá bán, phân khu, giỏ hàng và chính sách thanh toán cần xác nhận trực tiếp từ kênh Vinhomes chính thức.", status: "in-progress" },
  { id: 3, title: "Triển khai hạ tầng đại đô thị", date: "Giai đoạn đầu", description: "Định hướng phát triển đồng bộ hạ tầng, công viên, tiện ích và sản phẩm thấp tầng trong đại đô thị." },
  { id: 4, title: "Bàn giao", date: "Theo từng phân khu", description: "Thời gian bàn giao cần đối chiếu theo hợp đồng mua bán và thông báo chính thức từ chủ đầu tư." },
]

const progressGallery = [
  { src: "/vinhomes-saigon-park/tongquan1.jpg", title: "Tiến độ triển khai Vinhomes Sài Gòn Park" },
  { src: "/vinhomes-saigon-park/matbangtienich.jpg", title: "Cập nhật quy hoạch tiện ích Vinhomes Sài Gòn Park" },
]

const progressUpdateSections = [
  {
    title: "Tiến độ triển khai đại đô thị",
    items: [
      { label: "Khởi công", text: "Dự án được thị trường ghi nhận khởi công trong năm 2026; thông tin tiến độ chi tiết cần theo dõi từ kênh Vinhomes chính thức." },
      { label: "Quy hoạch", text: "Định hướng khu đô thị Đại học Quốc tế quy mô khoảng 1.080ha, phát triển theo mô hình thành phố công viên tri thức." },
      { label: "Hạ tầng kết nối", text: "Khu vực hưởng lợi từ Quốc lộ 22, Metro số 2, Vành đai 3 và cao tốc TP.HCM - Mộc Bài." },
      { label: "Giai đoạn mở bán", text: "Phân khu, giỏ hàng, bảng giá và chính sách thanh toán đang được cập nhật theo từng đợt công bố." },
    ],
  },
  {
    title: "Thông tin mở bán & sản phẩm",
    subtitle: "Đang cập nhật",
    items: [
      { label: "Nhà phố liền kề", text: "Dòng sản phẩm thấp tầng phù hợp nhu cầu an cư, đầu tư và khai thác kinh doanh." },
      { label: "Nhà phố / Shop", text: "Sản phẩm thương mại diện tích 50-100m², hưởng lợi từ cộng đồng cư dân, trường học, dịch vụ và luồng khách nội khu." },
      { label: "Villa", text: "Không gian sống riêng tư diện tích 150-250m², gắn với công viên, mặt nước và hệ tiện ích Vingroup." },
    ],
  },
  {
    title: "Thông tin pháp lý & tiêu chuẩn thi công",
    items: [
      { label: "Pháp lý", text: "Khách hàng cần đối chiếu hồ sơ quy hoạch, điều kiện bán hàng, ngân hàng bảo lãnh và mẫu hợp đồng từ chủ đầu tư." },
      { label: "Chính sách", text: "Giá bán, lịch thanh toán, hỗ trợ lãi suất và ưu đãi chỉ nên sử dụng theo tài liệu bán hàng chính thức từng thời điểm." },
    ],
  },
]

const legalDocuments = [
  "Thông tin quy hoạch chi tiết và pháp lý dự án cần đối chiếu từ chủ đầu tư",
  "Văn bản đủ điều kiện bán hàng theo từng phân khu/giai đoạn mở bán",
  "Ngân hàng bảo lãnh và chính sách thanh toán chính thức",
  "Hình thức sở hữu theo quy định pháp luật hiện hành",
]

/* ─── Main Component ─── */
export default function VinhomesSaigonParkLandingPage() {
  const [isHeroLoaded, setIsHeroLoaded] = useState(false)
  const [selectedProduct, setSelectedProduct] = useState("lienke")
  const [formData, setFormData] = useState({ 
    ...
    product: "", 
    message: "", 
    subject: "Đăng ký tư vấn dự án Vinhomes Sài Gòn Park" 
  })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        setIsSubmitted(true)
        setTimeout(() => {
          setFormData({ name: '', email: '', phone: '', product: '', message: '', subject: 'Đăng ký tư vấn dự án Vinhomes Sài Gòn Park' })
    ...
    <main className="min-h-screen bg-[#F4F7F0] overflow-x-hidden selection:bg-[#2E7D32] selection:text-white">
        ...
        <div className="w-full">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div className="md:hidden flex items-center justify-between py-3">
              <span className="text-[#1B5E20] font-bold text-base tracking-wider font-sans">VINHOMES SÀI GÒN PARK</span>
      ...
      <section className="relative min-h-[100svh] flex items-end pb-12 md:pb-24 justify-center overflow-hidden pt-24">
        <div className="absolute inset-0 z-0">
          <Image src="/vinhomes-saigon-park/tongquan1.jpg" alt="Tổng quan Vinhomes Sài Gòn Park" fill className="object-cover" priority />
        ...
        <div className={cn("relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 transition-all duration-1000", isHeroLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}>
          <div className="flex justify-center mb-6 md:mb-8">
            <div className="flex items-center gap-2 border border-[#C8A951]/50 rounded-full px-5 py-2.5 bg-[#C8A951]/10 backdrop-blur-md">
              ...
              <span className="text-[#C8A951] text-[11px] md:text-xs font-bold tracking-[0.2em] uppercase font-sans">Thành Phố Công Viên Tri Thức</span>
              <Star className="w-3 h-3 text-[#C8A951] fill-[#C8A951]" />
            </div>
          </div>
          <h1 className="text-center text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-4 md:mb-6 tracking-tight leading-none font-sans drop-shadow-lg">
            VINHOMES<br className="sm:hidden" /> <span className="text-[#C8A951]">SÀI GÒN PARK</span>
          </h1>
          <p className="text-center text-white/90 text-base sm:text-xl md:text-2xl max-w-2xl mx-auto mb-4 md:mb-5 font-medium font-sans">Đại đô thị công viên tri thức tại cửa ngõ Tây Bắc TP.HCM</p>
          <div className="flex items-center justify-center gap-2 mb-8 md:mb-12">
            <MapPin size={16} className="text-[#4CAF50] shrink-0" />
            <p className="text-white/70 text-sm sm:text-base font-sans">Xuân Thới Sơn, Hóc Môn cũ, TP.HCM</p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-4xl mx-auto mb-10 md:mb-14">
            {[
              { value: "1.080", unit: "ha", label: "Quy mô đại đô thị" },
              { value: "150", unit: "ha", label: "Khu đại học quốc tế" },
              { value: "5", unit: "phân khu", label: "Thành phố công viên" },
              { value: "31%", unit: "", label: "Mật độ xây dựng tham khảo" },
            ].map((stat) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal direction="up">
            <div className="text-center max-w-3xl mx-auto mb-16 md:mb-20">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#1A2E1A] mb-6 leading-tight font-sans">Đại Đô Thị Tri Thức Tại Tây Bắc TP.HCM</h2>
              <p className="text-[#3D5A3E] text-base md:text-lg leading-relaxed font-sans">Vinhomes Sài Gòn Park, còn được biết đến với tên gọi Vinhomes Hóc Môn, là đại đô thị quy mô khoảng 1.080ha do Vinhomes phát triển, định hướng trở thành khu đô thị Đại học Quốc tế kiểu mẫu tại cửa ngõ Tây Bắc TP.HCM.</p>
            </div>
          </Reveal>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20 md:mb-24">
            <Reveal direction="left">
              <div 
                ...
                onClick={() => setZoomedImage({ src: "/vinhomes-saigon-park/tongquan1.jpg", alt: "Phối cảnh tổng thể Vinhomes Sài Gòn Park" })}
              >
                <div className="relative aspect-[4/3]">
                  <Image 
                    src="/vinhomes-saigon-park/tongquan1.jpg" 
                    alt="Phối cảnh tổng thể Vinhomes Sài Gòn Park" 
                    fill 
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 pointer-events-none z-10">
                  <h3 className="text-white font-bold text-xl md:text-2xl mb-2 font-sans">Biểu tượng đô thị tri thức phía Tây Bắc</h3>
                  <p className="text-white/80 text-sm md:text-base font-sans">Tích hợp hệ sinh thái Vingroup với giáo dục, y tế, thương mại, công viên, mặt nước và sân golf.</p>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal direction="right">
              <div className="space-y-8 md:space-y-10">
                <div className="grid grid-cols-2 gap-6 md:gap-8">
                  {[
                    { label: "Chủ đầu tư", value: "Vingroup / Vinhomes" },
                    { label: "Nhà phát triển", value: "Vingroup / Vinhomes" },
                    { label: "Quy mô", value: "~1.080 ha" },
                    { label: "Vị trí", value: "Xuân Thới Sơn, Hóc Môn" },
                  ].map((item) => (
                ...
                <div className="bg-gradient-to-br from-[#E8F0E8] to-[#F0F7F0] rounded-3xl p-8 md:p-10 border border-[#D4E8D0] shadow-sm">
                  ...
                  <ul className="space-y-5">
                    {[
                      { label: "Đại đô thị 5 phân khu", desc: "Quy hoạch theo mô hình thành phố công viên tri thức với khu đại học quốc tế, thương mại, giáo dục và không gian sống xanh." },
                      { label: "Khu thấp tầng", desc: "Nhà phố liền kề, shophouse và biệt thự phục vụ nhu cầu ở, kinh doanh và đầu tư." },
                      { label: "Trung tâm tiện ích", desc: "Hệ tiện ích all-in-one: Vincom, Vinmec, Vinschool, công viên, kênh đào, sân golf và khu thể thao." },
                      { label: "Khu đại học", desc: "Không gian giáo dục quốc tế quy mô lớn, tạo cộng đồng cư dân tri thức và chuyên gia." },
                    ].map((item) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <Reveal direction="up" className="flex justify-center mb-12">
            <div className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full border border-[#2E7D32]/20 bg-[#E8F5E9]">
              ...
              <span className="text-[#2E7D32] text-[11px] font-bold uppercase tracking-[0.22em] font-sans">Đặc quyền sở hữu — Vinhomes Sài Gòn Park</span>
            ...
            <Reveal direction="left" className="relative h-full flex flex-col justify-center">
              <div className="relative mx-auto w-full max-w-[460px] lg:max-w-none pt-4 pb-10 px-8 lg:pl-4 lg:pr-10">
                <div 
                  ...
                  onClick={() => setZoomedImage({ src: "/vinhomes-saigon-park/nhapholienke.jpg", alt: "Vinhomes Sài Gòn Park — Đại đô thị Tây Bắc TP.HCM" })}
                >
                  <Image
                    src="/vinhomes-saigon-park/nhapholienke.jpg"
                    alt="Vinhomes Sài Gòn Park — Đại đô thị Tây Bắc TP.HCM"
                    fill
                  ...
                  <div className="absolute top-5 left-5 flex items-center gap-1.5 bg-white/15 backdrop-blur-md rounded-full px-3.5 py-1.5 border border-white/25 pointer-events-none">
                    ...
                    <span className="text-white text-[10px] font-bold tracking-widest uppercase font-sans">Đô Thị Tri Thức</span>
                  </div>
        
                  <div className="absolute bottom-0 inset-x-0 p-6 pointer-events-none">
                    <p className="text-white/55 text-[10px] uppercase tracking-widest font-bold mb-0.5 font-sans">Quốc lộ 22</p>
                    <p className="text-white font-bold text-base font-sans">Tây Bắc TP.HCM, Mộc Bài</p>
                  </div>
                </div>
                ...
                <div className="absolute bottom-0 right-0 bg-[#0D1F0D] rounded-2xl px-6 py-4 shadow-[0_16px_40px_rgba(13,31,13,0.3)] border border-white/10 z-20 text-right pointer-events-none">
                  <p className="text-white/45 text-[10px] uppercase tracking-widest mb-0.5 font-sans">Giá bán</p>
                  <p className="text-[#C8A951] text-2xl font-bold leading-none font-sans">Cập nhật</p>
                  <p className="text-white/55 text-[11px] mt-0.5 font-sans">theo phân khu</p>
            ...
            <Reveal direction="right" className="flex flex-col gap-6 h-full justify-center mt-0 lg:-mt-4">
              <div className="space-y-4">
                <h2 className="text-3xl md:text-4xl lg:text-[2.5rem] font-bold text-[#1A2E1A] leading-[1.25] md:leading-[1.3] font-sans tracking-tight text-balance">
                  Đừng bỏ lỡ cơ hội sở hữu <span className="text-[#2E7D32]">bất động sản thấp tầng</span> <br className="hidden md:block" /> duy nhất tại{" "}
                  <span className="relative inline-block">
                    <span className="relative z-10 text-[#2E7D32] italic">Tây Bắc TP.HCM</span>
                ...
                <p className="text-[#3D5A3E] text-sm md:text-[15px] leading-relaxed font-sans text-balance mt-2">
                  Sở hữu bất động sản <strong className="text-[#1A2E1A]">đại đô thị công viên tri thức</strong> tại cửa ngõ Tây Bắc TP.HCM, liền kề Quốc lộ 22,{" "}
                  <span className="text-[#2E7D32] font-bold">đón sóng hạ tầng</span> — bảng giá và chính sách đang được cập nhật theo từng phân khu.
                </p>
              </div>
              ...
              <div className="space-y-2.5">
                {[
                  { icon: MapPin, title: "Vị Trí Chiến Lược",  desc: "Nằm tại cửa ngõ Tây Bắc TP.HCM, kết nối Quốc lộ 22, Quận 12, Củ Chi, Tây Ninh và trung tâm TP.HCM.", tag: "Tây Bắc TP.HCM", target: "location" },
                  { icon: Leaf,   title: "Đô Thị Tri Thức", desc: "Tích hợp công viên, mặt nước, giáo dục quốc tế, thương mại, y tế và hệ tiện ích Vingroup.", tag: "Tiện ích",        target: "amenities" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <Reveal direction="up">
            <div className="text-center max-w-3xl mx-auto mb-16 md:mb-20">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight font-sans">Tâm Điểm Quốc Lộ 22</h2>
              <p className="text-white/70 text-base md:text-lg leading-relaxed font-sans">
                Tọa lạc tại khu vực Xuân Thới Sơn, Hóc Môn cũ, Vinhomes Sài Gòn Park nằm tại cửa ngõ Tây Bắc TP.HCM, kết nối Quốc lộ 22, Đặng Công Bỉnh, Vành đai 3, Metro số 2 và cao tốc TP.HCM - Mộc Bài.
              </p>
            </div>
          </Reveal>
          ...
          <div className="grid lg:grid-cols-5 gap-8 md:gap-12 mb-12 md:mb-16">
            ...
            <Reveal direction="left" className="lg:col-span-3">
              <div 
                onClick={() => setZoomedImage({ src: "/vinhomes-saigon-park/vitri.jpg", alt: "Bản đồ vị trí Vinhomes Sài Gòn Park" })}
                ...
                tabIndex={0}
                onKeyDown={(e) => { if (e.key === 'Enter') setZoomedImage({ src: "/vinhomes-saigon-park/vitri.jpg", alt: "Bản đồ vị trí Vinhomes Sài Gòn Park" }) }}
              >
                <Image src="/vinhomes-saigon-park/vitri.jpg" alt="Bản đồ vị trí Vinhomes Sài Gòn Park" fill className="object-contain p-4 transition-transform duration-700 group-hover:scale-[1.02]" />
                ...
                <div className="absolute bottom-6 left-6 bg-white/95 backdrop-blur-md rounded-2xl px-5 py-4 shadow-xl border border-[#D4E8D0] pointer-events-none flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-[#1A2E1A] font-bold text-base font-sans">VINHOMES SÀI GÒN PARK</p>
            ...
            <form onSubmit={handleSubmit} className="w-full lg:w-auto flex flex-col sm:flex-row gap-3">
              <Input 
                ...
                onChange={(e) => setFormData({
                  ...
                  subject: "Yêu cầu tải trọn bộ tài liệu dự án Vinhomes Sài Gòn Park"
                })}
                  ...
                  <a href="#contact"
                    onClick={() => {
                        ...
                        setFormData({ 
                            ...
                            subject: `Yêu cầu tư vấn ${activeProduct.name}`,
                            email: formData.email || "khachhang@form.sanpham",
                            message: `Khách quan tâm ${activeProduct.name}` 
                        });
                    }}
          ...
          <Reveal direction="up" delay={0.3} className="mt-24 pt-24 border-t border-[#D4E8D0]" id="showroom">
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#1A2E1A] mb-6 leading-tight font-sans">
                Phối Cảnh & Không Gian Dự Án
              </h2>
              <p className="text-[#3D5A3E] text-base md:text-lg leading-relaxed font-sans">
                Cập nhật tiến độ thi công và không gian tiện ích của Vinhomes Sài Gòn Park — đang xây dựng nhộn nhịp tại Tây Bắc TP.HCM.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <Reveal direction="up">
            <div className="text-center max-w-3xl mx-auto mb-16 md:mb-20">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight font-sans">
                Hệ Tiện Ích Vinhomes All-in-one
              </h2>
              <p className="text-white/70 text-base md:text-lg leading-relaxed font-sans">
                Vinhomes Sài Gòn Park được định hướng tích hợp hệ sinh thái Vingroup với Vincom, Vinmec, Vinschool, khu đại học quốc tế, công viên, kênh đào, sân golf và các tiện ích vận động - giải trí.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal direction="up">
            <div 
              ...
              onClick={() => setZoomedImage({ src: "/vinhomes-saigon-park/matbangtienich.jpg", alt: "Sơ đồ tiện ích — Vinhomes Sài Gòn Park" })}
            >
              <Image src="/vinhomes-saigon-park/matbangtienich.jpg"
                alt="Tổng quan tiện ích Vinhomes Sài Gòn Park" width={1400} height={700}
            ...
            <p className="text-center text-white/50 text-xs font-bold uppercase tracking-[0.2em] mb-20 font-sans">Sơ đồ tiện ích tổng thể — Vinhomes Sài Gòn Park</p>
          </Reveal>
      ...
      <section className="relative py-20 bg-[#0A160A] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          <div className="bg-gradient-to-r from-[#1A2E1A] to-[#0D1F0D] border border-white/10 rounded-[3rem] p-10 md:p-16 flex flex-col items-center text-center max-w-5xl mx-auto">
            ...
            <h3 className="text-3xl md:text-5xl font-bold text-white mb-6 font-sans">Nhận Thông Tin Chính Sách Vinhomes</h3>
            ...
            <form onSubmit={handleSubmit} className="w-full grid grid-cols-1 md:grid-cols-3 gap-4">
              <Input 
                ...
                onChange={(e) => setFormData({
                  ...
                  subject: "Đăng ký nhận chính sách Vinhomes Sài Gòn Park",
              ...
              <div className="relative">
                ...
                >
                  <option value="" className="bg-[#0D1F0D]">Chọn sản phẩm</option>
                  <option value="Nhà phố liền kề" className="bg-[#0D1F0D]">Nhà phố liền kề</option>
                  <option value="Nhà phố / Shop" className="bg-[#0D1F0D]">Nhà phố / Shop</option>
                  <option value="Villa" className="bg-[#0D1F0D]">Villa</option>
                </select>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal direction="up">
            <div className="text-center max-w-3xl mx-auto mb-20">
              ...
              <p className="text-[#3D5A3E] text-base md:text-lg leading-relaxed font-sans">
                Dự án do Vinhomes phát triển; khách hàng nên đối chiếu hồ sơ pháp lý, tiến độ và chính sách bán hàng bằng tài liệu chính thức trước khi giao dịch.
              </p>
            </div>
          </Reveal>
              ...
              <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
                <div className="lg:col-span-2 space-y-5">
                  ...
                  <h3 className="text-2xl md:text-4xl font-bold text-[#1A2E1A] leading-tight font-sans">
                    Tiến Độ Dự Án Vinhomes Sài Gòn Park
                  </h3>
                  <p className="text-[#3D5A3E] text-sm md:text-base leading-relaxed font-sans">
                    Chào bạn, tính đến thời điểm hiện tại, dự án Vinhomes Sài Gòn Park tại khu đô thị Tây Bắc TP.HCM, Xuân Thới Sơn, Hóc Môn đang được đẩy nhanh tiến độ thi công một cách khẩn trương.
                  </p>
                  <p className="text-[#3D5A3E] text-sm md:text-base leading-relaxed font-sans">
                    Thông tin triển khai hiện tại cho thấy Vinhomes Sài Gòn Park đang được định vị là biểu tượng sống chuẩn thành phố công viên tri thức tại cửa ngõ Tây Bắc TP.HCM.
                  </p>

                  <div className="grid grid-cols-2 gap-3 pt-2">
                    {[
                      { value: "1.080ha", label: "Quy mô dự án" },
                      { value: "150ha", label: "Khu đại học" },
                      { value: "2026", label: "Năm khởi công" },
                      { value: "5", label: "Phân khu dự kiến" },
                    ].map((item) => (
            ...
            <Reveal direction="left">
              <div>
                ...
                <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-[#1A2E1A] mb-6 leading-tight font-sans text-balance">
                  Nhận Bảng Giá Và Mặt Bằng Vinhomes Sài Gòn Park.
                </h2>
                <p className="text-[#3D5A3E] text-base md:text-lg leading-relaxed mb-10 md:mb-12 font-sans max-w-lg">
                  Đăng ký để nhận thông tin dự án Vinhomes Sài Gòn Park, mặt bằng sản phẩm, giá tham khảo và chính sách bán hàng mới nhất.
                </p>
              ...
              <div className="bg-white rounded-[2.5rem] p-8 sm:p-10 md:p-12 shadow-2xl border border-[#D4E8D0]">
                ...
                {isSubmitted ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-[#3D5A3E] text-base mb-8 leading-relaxed font-sans">Chuyên viên tư vấn Vinhomes Sài Gòn Park sẽ gọi lại cho quý khách trong thời gian sớm nhất.</p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5 font-sans">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <select value={formData.product} onChange={(e) => setFormData({ ...formData, product: e.target.value, subject: `Khách quan tâm ${e.target.value}` })}
                            ...
                            <option value="Nhà phố / Shop">Nhà phố / Shop</option>
